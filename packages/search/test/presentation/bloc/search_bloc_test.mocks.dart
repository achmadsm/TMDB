...
import 'package:search/domain/usecases/search_tv_shows.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSearchTvShows extends _i1.Mock implements _i8.SearchTvShows {
  MockSearchTvShows() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Tv>>> execute(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [query],
